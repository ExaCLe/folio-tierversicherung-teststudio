...
export function getTestingChatSnapshot(id:string):TestingChatSnapshot{
  ...
  return {conversation:clone(conversation),timeline,tasks:linkedJobs.map(job=>task(job,linkedJobs,chatQuestions)),questions:chatQuestions,scenario,proposed,lifecycle,
