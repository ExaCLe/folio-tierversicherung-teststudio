...
function publishValidatedResult(id:string,result:unknown){
  ...
  // Workflow control data stays on the job; the public report contains the
  // concrete problem in readable summary/fact form.
  const technicalData=job.phase==='technical'?{summary,...(facts.length?{facts}:{})}:undefined;
