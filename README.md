...
Die Fortschrittsanzeige zeigt erledigte Schritte, aktive Arbeitszweige und abrufbare Erläuterungen. Nach der fachlichen Freigabe startet die technische Vorbereitung automatisch. Die Anzeige zählt den alten fachlichen Prüfschritt im technischen Schritt nicht erneut als erledigt. Die Entwurfserstellung läuft nacheinander; technische Vorbereitung und Bausteinvergleich können parallel laufen. Ein Zeitlimit wird als technische Unterbrechung erklärt und nicht als Nutzerabbruch ausgegeben.
...
Bereits erreichte Schritte lassen sich ohne Neustart eines Agenten erneut ansehen. Jede Agentenkarte öffnet ein Dialogfenster mit dem tatsächlichen Ergebnis und den öffentlichen Erläuterungen des jeweiligen Auftrags. Benannte Quellen und Freigabehinweise öffnen sich dort ebenfalls. Die Freigabe unterscheidet Informationen, Warnungen und Fehler; eine noch fehlende technische Umsetzung ist während des fachlichen Entwurfs eine Information.
