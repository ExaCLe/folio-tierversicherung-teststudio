...
type View = 'scenarios' | 'start' | 'editor' | 'library' | 'knowledge' | 'graph' | 'runs' | 'method';
...
const navigation = [{ id: 'scenarios', label: 'Testfälle', icon: Layers3 }, { id: 'start', label: 'Neuer Testfall', icon: Plus }, { id: 'library', label: 'Blockbibliothek', icon: Layers3 }, { id: 'knowledge', label: 'Wissensbasis', icon: BookOpen }, { id: 'graph', label: 'Abhängigkeiten', icon: GitBranch }, { id: 'runs', label: 'Ausführungen', icon: History }, { id: 'method', label: 'So funktioniert es', icon: FileText }] as const;
const examples = [
